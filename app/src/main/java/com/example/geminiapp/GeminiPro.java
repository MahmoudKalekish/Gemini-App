...
// This class represent content sent to and received from the model
public class GeminiPro {
    public void getResponse(String query, ResponseCallback callback) {
        ...
        // This line is creating an executer that will be used to run the callback method
    ...
    private GenerativeModelFutures getModel() {
        ...
        // Safety settings are used to block unsafe content across all dimension
